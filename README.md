...
| 📝 [Русская локализация xFED](docs/patches/xfed-russian-localization.md) | 📦 [Fade's Equipment Distribution AIO](#-затронутые-моды) | 💡 Добавляет 23 отсутствующие строки и исправляет 4 описания, расходившиеся с механикой предметов |
| 🏺 [Русская локализация Ancient Mega Pack](docs/patches/ancient-mega-pack-russian-localization.md) | 📦 [Ancient Mega Pack](#-затронутые-моды) | 💡 Добавляет 2 отсутствующие пользовательские строки и обновляет устаревшее описание распылятора |
