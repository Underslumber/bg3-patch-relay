...
| Локальная копия | `D:/Projects/BG3_Mods/work/audit_installed_20260812/ancient/` — свежая распаковка установленного `.pak` |
...
| Исходники | Публичный репозиторий не указан; базис берётся из распакованного установленного `.pak` |
| Локальная копия | `D:/Projects/BG3_Mods/work/audit_installed_20260812/xfed/` — свежая распаковка установленного `.pak` |
